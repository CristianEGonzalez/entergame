...
const ContactModal: React.FC<ContactModalProps> = ({ isOpen, onClose }) => {
  ...
  // Controla si el formulario ya se envió
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // EN LUGAR DE CERRAR, CAMBIAMOS LA VISTA AL CANAL DE WHATSAPP
    setIsSubmitted(true);
  };
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                ...
                <div className="pt-2 flex flex-col gap-3">
                  ...
                  {/* Enlace a Instagram dentro del Modal */}
                  <a
                    href="https://instagram.com/entergame_ok"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full bg-gray-50 hover:bg-gray-100 border border-gray-200 text-gray-800 font-bold py-3 px-6 rounded-xl transition-all flex justify-center items-center gap-2.5 group"
                  >
                    <span className="flex items-center justify-center w-5">
                      <svg className="w-5 h-5 group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
                        <defs>
                          <radialGradient id="instagram-gradient-modal" cx="30%" cy="107%" r="150%">
                    ...
                    Seguinos en Instagram (@entergame_ok)
                  </a>
                </div>
              </form>
            </>
