      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 max-w-7xl w-full z-10 items-center">
        ...
        <div className="text-left animate-fade-in-up flex flex-col justify-center">
          ...
          <h1 className="text-3xl sm:text-4xl xl:text-5xl text-gray-900 leading-[1.1] mb-6 tracking-tight">
            ...
            <span className="text-red-600">Nintendo&nbsp;</span>
            <span className="text-brand-cyan">Switch&nbsp;</span>
          </h1>

          <p className="text-gray-600 text-lg sm:text-xl mb-8 leading-relaxed max-w-lg font-medium">
            Encontrá los mejores títulos para tu consola. Renová tu colección y
            dale una segunda vida a los juegos que ya pasaste al mejor precio.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12">
            <a
              href="#catalogo"
              className="bg-red-600 text-white font-orbitron font-bold text-lg py-3.5 px-8 rounded-2xl text-center hover:bg-red-700 hover:shadow-[0_8px_20px_rgba(220,38,38,0.4)] transition-all transform hover:-translate-y-1"
            >
              Ver Catálogo
            </a>
            <a
              ...
              className="bg-brand-cyan font-orbitron  text-white font-bold text-lg py-3 px-8 rounded-2xl text-center hover:bg-white-50 hover:shadow-[0_8px_20px_rgba(59,130,246,0.3)] transition-all transform hover:-translate-y-1"
            >
              Ofertas y Novedades
            </a>
            <ContactButton
              nombre="Contactar"
              className="bg-white border-2 font-orbitron border-blue-500 text-blue-600 font-bold text-lg py-3 px-8 rounded-2xl text-center hover:bg-blue-50 hover:shadow-[0_8px_20px_rgba(59,130,246,0.3)] transition-all transform hover:-translate-y-1"
            />
          </div>
